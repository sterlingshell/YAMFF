...
import io.github.sterlingshell.yamff.databinding.WindowAppMinimalBinding
...
class MinimalRenderer(context: Context) : BaseRenderer<WindowAppMinimalBinding>(context) {
    override val binding = WindowAppMinimalBinding.inflate(LayoutInflater.from(context))
    ...
    private fun setupSurfaceView() {
        ...
        binding.viewport.addView(internalBlurImageView, 0)
    ...
    private fun setupListeners() {
        ...
        binding.ibMinimize.setOnClickListener { internalActionHandler?.invoke(Action.ToggleMini) }
        binding.ibCollapse.setOnClickListener { internalActionHandler?.invoke(Action.Minimize) }
