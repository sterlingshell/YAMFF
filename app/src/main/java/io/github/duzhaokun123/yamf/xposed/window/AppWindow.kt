...
import io.github.duzhaokun123.yamf.xposed.window.logic.AppWindowLogic
import io.github.duzhaokun123.yamf.xposed.window.model.AppWindowAction
import io.github.duzhaokun123.yamf.xposed.window.render.AppWindowRenderer
import io.github.duzhaokun123.yamf.xposed.window.render.impl.ClassicAppWindowRenderer
import io.github.duzhaokun123.yamf.xposed.window.render.impl.GestureAppWindowRenderer
...
class AppWindow(
        ...
        renderer.setActionHandler { action ->
            when (action) {
                ...
                is AppWindowAction.RequestMoveToTop -> {
                    YAMFWindowManager.moveToTop(logic.displayId)
    ...
    private fun cleanup() {
        ...
        currentSurface = null
        YAMFWindowManager.removeWindow(logic.displayId)
    }
