...
import io.github.duzhaokun123.yamf.xposed.utils.MainThreadQueue
...
class AppWindowLogic(
    ...
    init {
        ...
        runCatching {
            val vd = SystemServices.displayManager.createVirtualDisplay("yamf${System.currentTimeMillis()}", initialRect.width(), initialRect.height(), densityDpi, null, flags)
            virtualDisplay = vd
