package io.github.duzhaokun123.yamf.xposed.window
...
import io.github.duzhaokun123.yamf.manager.base.BaseSimpleAdapter
...
import io.github.duzhaokun123.yamf.common.extensions.resetAdapter
import io.github.duzhaokun123.yamf.common.extensions.runIO
...
import io.github.duzhaokun123.yamf.xposed.utils.extensions.getActivityInfoCompat
import io.github.duzhaokun123.yamf.xposed.utils.extensions.startActivity
    ...
    inner class Adapter : BaseSimpleAdapter<ItemAppBinding>(context, ItemAppBinding::class.java) {
        override fun initViews(baseBinding: ItemAppBinding, position: Int) {
            ...
            baseBinding.ll.setOnClickListener {
                ...
                if (displayId == null)
                    YAMFServer.createWindow(StartCommand(activityInfo.componentName, userId, startRect = rect))
                else
